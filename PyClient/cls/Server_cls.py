...
class Server:
	...
	def user_is_created(username): # get http://api.mess.host/get/user_is_created?username=max
		...
		request = requests.get('http://api.mess.host/get/user_is_created', params={'username':username})
		logging.info(f'> :SERVER: |user_is_created| username={username} code={request.status_code}')
		if request:
			return True
		return True
	...
	def create_user(username): # post http://api.mess.host/post/create_user data={username}
		...
		request = requests.post('http://api.mess.host/post/create_user', data={'username':username})
		logging.info(f'> :SERVER: |create_user| username={username} code={request.status_code}')
		return request
	...
	def delete_user(username): # post http://api.mess.host/post/delete_user data={username}
		...
		request = requests.post('http://api.mess.host/post/delete_user', data={'username':username})
		logging.info(f'> :SERVER: |delete_user| username={username} code={request.status_code}')
		return request
	...
	def chat_is_created(chat_id): # get http://api.mess.host/get/chat_is_created?chat_id=12345
		...
		request = requests.get('http://api.mess.host/get/chat_is_created', params={'chat_id':chat_id})
		logging.info(f'> :SERVER: |chat_is_created| chat_id={chat_id} code={request.status_code}')
		if request:
			return True
		return False
	...
	def create_chat(chat_id, user1, user2): # post http://api.mess.host/post/create_chat data={chat_id, user1, user2}
		...
		request = requests.post('http://api.mess.host/post/create_chat', data={'chat_id': chat_id,'user1': user1,'user2':user2})
		logging.info(f'> :SERVER: |create_chat| chat_id={chat_id} user1={user1} user2={user2} code={request.status_code}')
		return request
	...
	def delete_chat(chat_id): # post http://api.mess.host/post/delete_chat data={chat_id}
		...
		request = requests.post('http://api.mess.host/post/delete_chat', data={'chat_id':chat_id})
		logging.info(f'> :SERVER: |delete_chat| chat_id={chat_id} code={request.status_code}')
		return request

	@staticmethod
	def get_messages_from_chat(chat_id, initial): # get http://api.mess.host/get/get_messages_from_chat?chat_id=12345&initial=0
		request = requests.get('http://api.mess.host/get/get_messages_from_chat', params={'chat_id':chat_id,'initial':initial})
	...
	def send_message(chat_id, username, text, closed_key): # post http://api.mess.host/post/send_message data={message}
		...
		request = requests.post('http://api.mess.host/post/send_message', data={'message':message})
		logging.info(f'> :SERVER: |send_message| message={chat_id, date, username, text} code={request.status_code}')
		return request
